...
var push             = Array.prototype.push
  ...
  , front, back, Resolved, Unresolved, deferred, promise;
...
back = {
	then: function (win, fail, resolve) {
		...
		return (resolve || promise)((cb == null) ? this.promise :
...
promise = module.exports = function (value) {
	var promise;
	...
	promise = function (win, fail) {
		...
		if (promise._base.resolved) {
			return back.then.call(promise._base, win, fail);
		} else {
			d = deferred();
